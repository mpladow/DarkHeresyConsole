...
namespace ConsoleApp1
{
    static class Skills
    {
        ...
        public static string BreakDoor(int charvalue, int difficulty = 0)
        {
            var modValue = CalculateSkill(charvalue, difficulty);
